        ...
        ExecStart = let
          script = pkgs.writeShellApplication {
            ...
            text = ''
              ...
              # Ensure traefik.yml exists to prevent Docker from creating it as a directory
              if [ ! -f "${cfg.dataDir}/traefik/traefik.yml" ]; then
                echo "Creating empty traefik.yml..."
                touch "${cfg.dataDir}/traefik/traefik.yml"
              fi
